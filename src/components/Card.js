...
const Card = ({ img, title, content, btn, action }) => {
  return (
    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 h-fit m-4">
      <Link to={action}>
        <img
